...
const st = StyleSheet.create({
  ...
  shareUrl: { fontSize: 13, color: C.ink, backgroundColor: C.tint, borderRadius: 8, padding: 10, fontVariant: ['tabular-nums'] },
  ...
  section: { gap: 12 },
  advice: { backgroundColor: C.tint, borderRadius: 10, padding: 14 },
